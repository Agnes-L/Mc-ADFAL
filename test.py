...
from metrics import get_cindex, get_rm2, r2_score
from dataset import *
...
def val(model, criterion, dataloader, device):
    ...
    r2s = r2_score(label, pred)
    running_loss.reset()

    return epoch_loss, epoch_cindex, epoch_r2, r2s
...
def main():
    ...
    test_loss, test_cindex, test_r2, test_r2s = val(model, criterion, test_loader, device)
    msg = "test_loss:%.4f, test_cindex:%.4f, test_r2:%.4f, test_r2s:%.4f" % (test_loss, test_cindex, test_r2, test_r2s)
    print(msg)
